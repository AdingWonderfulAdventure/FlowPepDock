...
老王啰嗦：这里把SO(3)热核相关的积分都预计算好，别重复造轮子
"""
...
if os.path.exists(".so3_omegas_array2.npy"):
    ...
    print('FlowPepDock is computing the necessary so3 params for the first run. It may take a few minutes.', flush=True)
